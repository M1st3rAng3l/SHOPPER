...
function Gallery(){
    ...
    const gallery = [
        ...
        {id:'04', imagen: img5, distribuidora:'Electra', name:'Cama Familiar ', precio:'1350.55'},
        {id:'05', imagen: img6, distribuidora:'ShoesMx', name:'Zapatilla Elegante', precio: '600'},
        {id:'06', imagen: img7, distribuidora:'ShoesMx', name:'Bota de Alta Resistencia', precio:'650.55'},
